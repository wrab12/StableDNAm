...
def get_config():
    ...
    parse.add_argument('-path_train_data2', type=str, default='../data/DNA_MS/tsv/5hmC/5hmC_H.sapiens/train.tsv',
                       help='训练数据2的位置')

    parse.add_argument('-path_test_data', type=str, default='../data/test.txt', help='训练数据的位置')

    parse.add_argument('-path-params', type=str, default=None, help='模型参数路径')  # 这里是没有加载模型参数的
    ...
    parse.add_argument('-epoch', type=int, default=20, help='迭代次数')  # 注意 数据集 6mA_R.chinensis需要训练100次
