...
def select_dataset():
    ...
    # path_train_data = '../data/DNA_MS/tsv/all/train.tsv'
    # path_test_data = '../data/DNA_MS/tsv/all/test.tsv'
...
if __name__ == '__main__':
    ...
    config.path_train_data1, config.path_test_data = select_dataset()
    print('--------------训练集为{}------------'.format(config.path_train_data1))
